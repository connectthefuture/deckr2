...
_CARD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tapped', full_name='Card.tapped', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='meta', full_name='Card.meta', index=12,
